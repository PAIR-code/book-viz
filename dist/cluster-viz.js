...
export function drawClusterPlot(data, text, chapterBreaks) {
    const num_levels = 3;
    const height = 200, width = 700;
    const contextHeight = 15;
    ...
    clusterSvg.selectAll()
        ...
        .attr("y", function (d) { return y(d.window_size + 1.5); })
    ...
    contextSvg.selectAll()
        ...
        .enter()
        .append("rect")
        .attr("x", function (d) { return x(d.chapter_start) + x(0.25); })
...
//# sourceMappingURL=cluster-viz.js.map